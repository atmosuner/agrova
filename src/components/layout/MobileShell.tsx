...
export function MobileShell() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-canvas pb-[calc(4.5rem+env(safe-area-inset-bottom,0px))] pt-[max(env(safe-area-inset-top,0px),20px)]">
      {/* Header */}
      <header className="sticky top-[max(env(safe-area-inset-top,0px),20px)] z-30 flex items-center justify-between gap-3 border-b border-border bg-surface-0/95 px-4 py-3 backdrop-blur supports-[backdrop-filter]:bg-surface-0/80">
